...
def argsparser():
    ...
    parser.add_argument('--camera_type', choices=["up", "side", "front"], default="side")
...
def get_variant(args):
    ...
    if args.image_training:
        variant['policy_kwargs'] = dict(
            ...
            input_dropout_prob=args.dropout_prob,
            dropout_probs=[args.dropout_prob, args.dropout_prob, args.dropout_prob, args.dropout_prob],
            init_w=1e-4,
